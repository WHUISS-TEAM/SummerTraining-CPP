...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   DrawPic(hdc, 780, 640);
   fbmp = (HBITMAP)LoadImage(NULL, "./img/1.bmp", IMAGE_BITMAP, FRONT_WID, FRONT_HEI, LR_LOADFROMFILE);
   ...
   FrontPic(hdc, 301, 135,FRONT_WID,FRONT_HEI);//棋盘的宽度是：
//棋盘的高度是：
   return TRUE;
}
